...
<!-- Comments Area -->
<div class="comments-area" id="comments" style="font-family: Georgia">
	<?php comment_form(); ?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<h3 class="comments-title">
			<?php 
				printf( _nx( 'Один комментарий', '%1$s комментария', get_comments_number(), 'Comment title', 'material' ), number_format_i18n( get_comments_number() ) );
			?>
		</h3>
