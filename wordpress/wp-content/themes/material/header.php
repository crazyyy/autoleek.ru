		...
		<div class="container header-contents">
			<div class="row">
				<div class="col-xs-9 sitelogo">
					<div class="site-logo">
                                                <img class=header-logo src="http://autoleek.ru/wp-content/uploads/2015/07/Logo.png" width="140" height="60" alt="Логотип"/>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a> <span> Устройство и эксплуатация автомобиля</span> <div class="tagline"><?php echo get_bloginfo ( 'description' );?></div>
					</div> <!-- end site-logo -->
				</div> <!-- end col-xs-3 -->
				<div class="col-xs-12">
